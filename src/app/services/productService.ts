...
let cache : any []= Object.assign([], _products);

export function init() {
    cache = Object.assign([], _products);
}
...
export function getAllItems() {
    if (!cache || cache.length < 5) cache = Object.assign([], _products);
    return cache
}
...
export function getItemsByPageNumber(
    ...
    if (!cache || cache.length<1) cache = Object.assign([], _products);
